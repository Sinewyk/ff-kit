...
function process(source) {
    ...
    chaptersCount = page.find('select#chap_select').first().children().length;
    lastUpdated = new Date(convertTime(page.find('#profile_top span[data-xutime]').first().data('xutime'))).toDateString();
    published = new Date(convertTime(page.find('#profile_top span[data-xutime]').last().data('xutime'))).toDateString();
