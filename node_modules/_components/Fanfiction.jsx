...
var Fanfiction = React.createClass({
    ...
    getInitialState: function() {
        //@todo: clean up that shit xD
        var data = this.getStateFromStoryStore();
        return {
            story: data,
            input: data.input
        };
    ...
    render: function() {
        ...
        <div className="main">
            <div>
                ...
                <button onClick={this.checkLink} disabled={!this.state.input || this.state.story.fetching}>{t.gettext('Check')}</button>
